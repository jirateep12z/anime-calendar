...
import { CreateAnimeCatalogEntryFromSchedule } from './create-anime-catalog-entry';

import type { AnimeCatalogEntry } from '../types/anime-catalog';
import type { AnimeDetailModel, AnimeDetailRow } from '../types/anime-detail';
import type { ScheduleEntry } from '../types/schedule';

function CreateGeneralRows(
  catalog_entry: AnimeCatalogEntry
...
export function CreateAnimeDetailFromSchedule(
  ...
  const catalog_entry = CreateAnimeCatalogEntryFromSchedule(schedule_entry);
  const detail_rows: readonly AnimeDetailRow[] = [
    ...
    ['สถานะออกอากาศ', FormatScheduleCountdown(schedule_entry, now_seconds)],
    [
      'ประเภท',
