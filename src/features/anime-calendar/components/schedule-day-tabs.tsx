...
import { FormatScheduleTabLabel } from '@/features/anime-schedule';
...
export function ScheduleDayTabs({
  ...
  return (
    <div
      ...
      className="flex w-full min-w-0 items-center gap-1 overflow-x-auto rounded-lg border p-1 sm:overflow-visible"
    >
      {schedule_dates.map((schedule_date, date_index) => {
        ...
        return (
          <Button
            ...
            className="h-auto min-w-12 shrink-0 flex-col gap-0.5 px-2 py-1 sm:min-w-0 sm:flex-1"
